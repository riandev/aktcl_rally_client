...
const Reports = () => {
  ...
  useEffect(() => {
    fetch("http://192.168.200.10:5020/reports")
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        setReport(data);
  ...
  useEffect(() => {
    fetch("http://192.168.200.10:5020/reportDates")
      .then((res) => res.json())
  ...
  function handlePrepare(pdate) {
    console.log(pdate);
    fetch("http://192.168.200.10:5020/prepareByDate?date=" + pdate)
      .then((res) => res.json())
  ...
  let headers = [
    ...
    { label: "callDate", key: "callDate" },
    { label: "callDate1", key: "callDate1" },
    { label: "avgSalary", key: "avgSalary" },
