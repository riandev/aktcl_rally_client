...
const ReportBoard = () => {
  ...
  const handleConnected = () => {
    fetch(
      "http://192.168.10.11:5020/updateConnectCall?reportDate=" + reportDate
    )
      .then((res) => res.json())
      .then((data) =>
        setCondition1([
  ...
  const handleCondition1 = () => {
    fetch("http://192.168.10.11:5020/update1", {
      method: "PATCH",
  ...
  const handleTrueContact = () => {
    fetch("http://192.168.10.11:5020/getTrueContact?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateTrueContact = () => {
    fetch("http://192.168.10.11:5020/updateTrueContact", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleSOB1 = () => {
    fetch("http://192.168.10.11:5020/nonSOB1?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateSOB1 = () => {
    fetch("http://192.168.10.11:5020/updatenonSOB1", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleSOB2 = () => {
    fetch("http://192.168.10.11:5020/nonSOB2?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateSOB2 = () => {
    fetch("http://192.168.10.11:5020/updatenonSOB2", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleExtMSB = () => {
    fetch("http://192.168.10.11:5020/extMSB?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateExtMSB = () => {
    fetch("http://192.168.10.11:5020/updateextMSB", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleNotContacted1 = () => {
    fetch("http://192.168.10.11:5020/notContacted1?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
        setnotContacted1([
  ...
  const updateNotContacted1 = () => {
    fetch("http://192.168.10.11:5020/updateNotContacted1", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleNotContacted2 = () => {
    fetch("http://192.168.10.11:5020/notContacted2?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
        setnotContacted2([
  ...
  const updateNotContacted2 = () => {
    fetch("http://192.168.10.11:5020/updateNotContacted2", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleNotContacted3 = () => {
    fetch("http://192.168.10.11:5020/notContacted3?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
        setnotContacted3([
  ...
  const updateNotContacted3 = () => {
    fetch("http://192.168.10.11:5020/updateNotContacted3", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleNotContacted4 = () => {
    fetch("http://192.168.10.11:5020/notContacted4?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
        setnotContacted4([
  ...
  const updateNotContacted4 = () => {
    fetch("http://192.168.10.11:5020/updateNotContacted4", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleNotContacted = () => {
    fetch(
      "http://192.168.10.11:5020/finalNotContacted?reportDate=" + reportDate
    )
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateNotContacted = () => {
    fetch("http://192.168.10.11:5020/updateFinalNotContacted", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handlePureNotContacted = () => {
    fetch("http://192.168.10.11:5020/pureNotContacted?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updatePureNotContacted = () => {
    fetch("http://192.168.10.11:5020/updateFinalPureNotContacted", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleFalseContact = () => {
    fetch("http://192.168.10.11:5020/falseContact?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
        setFalseContact([
  ...
  const updateFalseContact = () => {
    fetch("http://192.168.10.11:5020/updateFalseContact", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleVerifyTrueContact = () => {
    fetch(
      "http://192.168.10.11:5020/verifyFalseContact?reportDate=" + reportDate
    )
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateVerifyTrueContact = () => {
    fetch("http://192.168.10.11:5020/updateVerifiedTrueContact", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handlenoFreeSample = () => {
    fetch("http://192.168.10.11:5020/noFreeSample?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updatenoFreeSample = () => {
    fetch("http://192.168.10.11:5020/updateNoFreeSample", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleLessFreeSample = () => {
    fetch("http://192.168.10.11:5020/lessFreeSample?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
        setLessFreeSample([
  ...
  const updateLessFreeSample = () => {
    fetch("http://192.168.10.11:5020/updateLessFreeSample", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleTeaSnaks = () => {
    fetch("http://192.168.10.11:5020/teaSnaks?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateTeaSnaks = () => {
    fetch("http://192.168.10.11:5020/updateTeaSnaks", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleRetention = () => {
    fetch("http://192.168.10.11:5020/retention?reportDate=" + reportDate)
      .then((res) => res.json())
      .then((data) =>
  ...
  const updateRetention = () => {
    fetch("http://192.168.10.11:5020/updateRetention", {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
